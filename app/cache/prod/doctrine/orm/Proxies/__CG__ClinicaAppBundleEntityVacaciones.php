 ...
 */
class Vacaciones extends \Clinica\AppBundle\Entity\Vacaciones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'fechaInicio', 'fechaFinal');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Vacaciones $proxy) {
